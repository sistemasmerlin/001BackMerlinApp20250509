...
return new class extends Migration
{
    ...
    {
        Schema::create('recibo_caja_retenciones', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('F353_ID_CO_DOCTO_CRUCE')->nullable();
            ...
            $table->string('F351_ID_AUXILIAR_RETENCION')->nullable();

            $table->decimal('F354_VALOR_DB', 15, 2)->default(0);
            $table->decimal('F354_VALOR_CR', 15, 2)->default(0);
            $table->decimal('F351_BASE_GRAVABLE', 15, 2)->default(0);
    ...
    {
        Schema::dropIfExists('recibo_caja_retenciones');
    }
};
