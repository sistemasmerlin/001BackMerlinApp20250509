        ...
        $result = DB::connection('sqlsrv')
            ->select("SELECT t120.f120_id item
                ...
                ,CASE
                    ...
                    WHEN rtrim(t120.f120_referencia) = '408141850' THEN 'PORTAFOLIO CARRO'
                    ...
                    WHEN rtrim(t120.f120_referencia) = '408142700' THEN 'PORTAFOLIO CARRO'
                    ...
                    WHEN rtrim(t120.f120_referencia) = '408146100' THEN 'PORTAFOLIO CARRO'
                    WHEN rtrim(t120.f120_referencia) = '408146150' THEN 'PORTAFOLIO CARRO'
                    WHEN rtrim(t120.f120_referencia) = '408146900' THEN 'PORTAFOLIO CARRO'
                    WHEN rtrim(t120.f120_referencia) = '408202150' THEN 'PORTAFOLIO CARRO'
                    WHEN rtrim(t120.f120_referencia) = '408202600' THEN 'PORTAFOLIO CARRO'
                    WHEN rtrim(t120.f120_referencia) = '408203450' THEN 'PORTAFOLIO CARRO'
                    WHEN rtrim(t120.f120_referencia) = '408211850' THEN 'PORTAFOLIO CARRO'
                    WHEN rtrim(t120.f120_referencia) = '408214570' THEN 'PORTAFOLIO CARRO'
                    WHEN rtrim(t120.f120_referencia) = '408218550' THEN 'PORTAFOLIO CARRO'
                    WHEN rtrim(t120.f120_referencia) = '408239915' THEN 'PORTAFOLIO CARRO'
                    WHEN rtrim(t120.f120_referencia) = '408239920' THEN 'PORTAFOLIO CARRO'
                    WHEN rtrim(t120.f120_referencia) = '408248250' THEN 'PORTAFOLIO CARRO'
                    WHEN rtrim(t120.f120_referencia) = '408248800' THEN 'PORTAFOLIO CARRO'
                    WHEN rtrim(t120.f120_referencia) = '408248850' THEN 'PORTAFOLIO CARRO'
                    WHEN rtrim(t120.f120_referencia) = '408248900' THEN 'PORTAFOLIO CARRO'
                    ...
                    WHEN rtrim(t120.f120_referencia) = '408250250' THEN 'PORTAFOLIO CARRO'
                    WHEN rtrim(t120.f120_referencia) = '408250400' THEN 'PORTAFOLIO CARRO'
                    WHEN rtrim(t120.f120_referencia) = '408251450' THEN 'PORTAFOLIO CARRO'
                    WHEN rtrim(t120.f120_referencia) = '408251600' THEN 'PORTAFOLIO CARRO'
                    ...
                    WHEN rtrim(t120.f120_referencia) = '408253000' THEN 'PORTAFOLIO CARRO'
                    WHEN rtrim(t120.f120_referencia) = '408253450' THEN 'PORTAFOLIO CARRO'
                    WHEN rtrim(t120.f120_referencia) = '408253500' THEN 'PORTAFOLIO CARRO'
                    ...
                    WHEN rtrim(t120.f120_referencia) = '408254850' THEN 'PORTAFOLIO CARRO'
                    WHEN rtrim(t120.f120_referencia) = '408255320' THEN 'PORTAFOLIO CARRO'
                    WHEN rtrim(t120.f120_referencia) = '408255350' THEN 'PORTAFOLIO CARRO'
                    WHEN rtrim(t120.f120_referencia) = '409052070' THEN 'PORTAFOLIO CARRO'
                    ...
                    WHEN rtrim(t120.f120_referencia) = '306203000' THEN 'PORTAFOLIO CARRO'
                    WHEN rtrim(t120.f120_referencia) = '306203050' THEN 'PORTAFOLIO CARRO'
                    WHEN rtrim(t120.f120_referencia) = '306203100' THEN 'PORTAFOLIO CARRO'
                    WHEN rtrim(t120.f120_referencia) = '306203150' THEN 'PORTAFOLIO CARRO'
                    WHEN rtrim(t120.f120_referencia) = '306203200' THEN 'PORTAFOLIO CARRO'
                    WHEN rtrim(t120.f120_referencia) = '306203250' THEN 'PORTAFOLIO CARRO'
                    WHEN rtrim(t120.f120_referencia) = '306203300' THEN 'PORTAFOLIO CARRO'
                    WHEN rtrim(t120.f120_referencia) = '306203350' THEN 'PORTAFOLIO CARRO'
                    WHEN rtrim(t120.f120_referencia) = '306203400' THEN 'PORTAFOLIO CARRO'
                    WHEN rtrim(t120.f120_referencia) = '306203450' THEN 'PORTAFOLIO CARRO'
                    WHEN rtrim(t120.f120_referencia) = '306303510' THEN 'PORTAFOLIO CARRO'
                    WHEN rtrim(t120.f120_referencia) = '306303600' THEN 'PORTAFOLIO CARRO'
                    WHEN rtrim(t120.f120_referencia) = '306303650' THEN 'PORTAFOLIO CARRO'
                    WHEN rtrim(t120.f120_referencia) = '306303700' THEN 'PORTAFOLIO CARRO'
                    WHEN rtrim(t120.f120_referencia) = '306303750' THEN 'PORTAFOLIO CARRO'
                    WHEN rtrim(t120.f120_referencia) = '306303800' THEN 'PORTAFOLIO CARRO'
                    WHEN rtrim(t120.f120_referencia) = '306303850' THEN 'PORTAFOLIO CARRO'
                    WHEN rtrim(t120.f120_referencia) = '306303900' THEN 'PORTAFOLIO CARRO'
                    WHEN rtrim(t120.f120_referencia) = '306303950' THEN 'PORTAFOLIO CARRO'
                    WHEN rtrim(t120.f120_referencia) = '306304050' THEN 'PORTAFOLIO CARRO'
                    WHEN rtrim(t120.f120_referencia) = '306304100' THEN 'PORTAFOLIO CARRO'
                    WHEN rtrim(t120.f120_referencia) = '306504350' THEN 'PORTAFOLIO CARRO'
                    WHEN rtrim(t120.f120_referencia) = '306504400' THEN 'PORTAFOLIO CARRO'
                    WHEN rtrim(t120.f120_referencia) = '306504450' THEN 'PORTAFOLIO CARRO'
                ELSE
