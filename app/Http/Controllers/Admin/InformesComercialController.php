...
class InformesComercialController extends Controller
{
    public function ventasPeriodo(Request $request, $id)
    {
        ...
        $result = DB::connection('sqlsrv')
            ...
            AND t106.f106_descripcion IN ('RINOVA TIRES', 'PIRELLI', 'RINOVA LIGHTING','RINOVA LIGHTING LED', 'PIRELLI RADIAL','NARVA', 'KOYO', 'PFI', 'RNV', 'BATERIAS RINOVA', 'RINOVA - GOOD TUBE', 'HAKUBA - ARMOR - WDT', 'WDT','CST TIRES', 'WDT BIKE' ,'WDT TUBE', 'WDT E-SCOOTER','FORERUNNER','CST ATV','WORCRAFT','CST E-SCOOTER','RINOVA PARTS')
