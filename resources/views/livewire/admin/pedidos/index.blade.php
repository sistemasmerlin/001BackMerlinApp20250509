<div class="space-y-6">
    ...
    <div class="w-full mx-auto rounded-xl shadow-lg border border-gray-200 dark:border-zinc-700 p-6">
                        ...
                        <td class="px-6 py-4 border-t-2">
                            ...
                            <div class="flex items-center gap-2">
                                @if($pedido->nota === 'Negociación especial' && $pedido->nit < 500)
                                    <flux:modal.trigger name="confirmar-cliente-creado" wire:click="abrirModalClienteCreado({{ $pedido->id }})">
                                    <button class="px-3 py-1 bg-gray-500 hover:bg-gray-700 text-white font-semibold rounded-lg mt-2">
        ...
        <flux:modal name="confirmar-cliente-creado" class="md:w-96"
            x-data
            x-ref="clienteCreado"
