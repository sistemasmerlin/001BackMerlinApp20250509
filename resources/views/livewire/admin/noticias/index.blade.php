<div class="space-y-6">
    ...
    <div class="flex justify-between items-center mb-4">
        <h1 class="text-2xl font-bold text-gray-800 dark:text-white">Noticias</h1>
        ...
        <table class="w-full mx-auto table-auto text-sm text-left text-gray-700 dark:text-zinc-300">
            <thead class="text-xs text-gray-600 uppercase bg-gray-100 dark:bg-zinc-700">
                <tr>
                    ...
                    <th class="px-4 py-3">Fecha Activación</th>
            ...
            <tbody>
                ...
                <tr class="border-b border-gray-200">
                    ...
                    <td class="flex space-x-2 py-2">
                        ...
                        <button wire:click="confirmarEliminar({{ $noticia->id }})" class="px-3 py-1 bg-red-500 hover:bg-red-800 text-white font-semibold rounded-lg"
    ...
    <div class="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
        <div class="bg-white p-6 rounded-lg space-y-4 w-full max-w-md shadow-xl">
            ...
            <div class="space-y-2">
                ...
                <input type="text" wire:model="titulo" class="w-full border rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500">

                <label class="block text-sm font-medium">Detalle</label>
                <textarea wire:model="detalle" class="w-full border rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500"></textarea>

                <label class="block text-sm font-medium">Fecha Activación</label>
                <input type="date" wire:model="fecha_activacion" class="w-full border rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500">
            </div>
    ...
    <div class="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
        <div class="bg-white p-6 rounded-lg space-y-4 w-full max-w-sm text-center shadow-xl">
            ...
            <div class="flex justify-center space-x-4 pt-4">
                <button wire:click="$set('confirmarEliminacion', false)" class="px-4 py-2 bg-gray-500 hover:bg-gray-600 text-white rounded">
                    Cancelar
                </button>
                <button wire:click="eliminar" class="px-4 py-2 bg-red-600 hover:bg-red-700 text-white rounded">
                    Eliminar
                </button>
            </div>
