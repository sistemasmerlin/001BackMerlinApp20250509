            ...
            <div class="overflow-hidden rounded-xl border border-zinc-300 bg-white">
                <table class="min-w-full text-sm text-black">
                    <tbody class="divide-y divide-zinc-200">
                                ...
                                <div class="mt-3 flex flex-col md:flex-row flex-wrap gap-2">
                                    ...
                                    @if(
                                        ...
                                        <button
                                            ...
                                            class="inline-flex items-center justify-center rounded-lg bg-red-600 px-4 py-2 text-xs font-semibold text-white shadow hover:bg-red-700 transition">
                                            Eliminar
                                        </button>
                                    @endif
                        ...
                        <tr>
                            <td class="px-5 py-4 align-top" colspan="3">
                                <div class="font-bold">NOTAS - OBSERVACIONES</div>
                                <div class="mt-1">
            ...
            <tbody class="divide-y divide-zinc-200">
                <tr>
                    ...
                    <td class="px-5 py-4 align-top">
                        ...
                        @if(!empty($pqrs->nota_acuerdo))
                            <a
                                href="{{ route('facturas.descargar', [
                                    'prefijo' => 'CNC',
                                    'consecutivo' => $pqrs->nota_acuerdo
                                ]) }}"
                                target="_blank"
                                class="mt-2 inline-flex items-center rounded-lg bg-zinc-900 px-3 py-2 text-xs font-semibold text-white hover:bg-black">
                                Ver nota crédito PDF
                            </a>
                        @endif
                    </td>
                   ...
                   <td class="px-5 py-4 align-top">
                        ...
                        <div class="mt-2 text-lg">{{ number_format($pqrs->valor_acuerdo) ?? '—' }}</div>
                    </td>
                </tr>
                <tr>
                    <td class="px-5 py-4 align-top" colspan="3">
...
@else
    <div class="rounded-lg border border-emerald-300 bg-emerald-50 p-4 text-sm text-emerald-800">
        Esta PQRS está cerrada. No se pueden agregar nuevos comentarios.
    </div>
@endif
