...
>
    <button
        type="button"
        class="group/disclosure-button mb-[2px] text-base flex h-10 w-full items-center rounded-lg text-zinc-50   hover:bg-zinc-800/5 hover:text-zinc-800 lg:h-8 dark:text-white/80 dark:hover:bg-white/[7%] dark:hover:text-white"
    >
        <div class="ps-3 pe-4">
