...
>
    <button
        type="button"
        class="group/disclosure-button mb-[2px] text-base flex h-10 w-full items-center rounded-lg text-zinc-700 hover:bg-zinc-800/5 hover:text-zinc-800 lg:h-8 dark:text-white/80 dark:hover:bg-white/[7%] dark:hover:text-white"
    >
        <div class="ps-3 pe-4">
        ...
        <span class="text-base font-medium leading-none">{{ $heading }}</span>
    </button>
...
<div {{ $attributes->class('block space-y-[2px]') }}>
    <div class="px-1 py-2">
        <div class="text-base leading-none text-zinc-700">{{ $heading }}</div>
    </div>
